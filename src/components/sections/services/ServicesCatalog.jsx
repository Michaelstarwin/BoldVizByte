                        ...
                        >
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 relative z-10">
                                <div>
                                    ...
                                    <Link to="/contact" className="inline-flex items-center px-8 py-4 bg-white text-black font-bold font-orbitron rounded-full hover:bg-neon-blue transition-colors">
