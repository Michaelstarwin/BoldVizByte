...
const milestones = [
    { year: "202x", title: "Idea Born", desc: "The vision of BoldVizByte was conceptualized." },
    { year: "202x", title: "First Client", desc: "Successfully delivered our first digital solution." },
    { year: "202x", title: "Expansion", desc: "Grew our team and expanded service offerings." },
