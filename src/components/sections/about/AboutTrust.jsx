    ...
    return (
        <section className="py-20 bg-dark-bg relative">
            <div className="container mx-auto px-6">
                ...
                {/* 2. Why Trust Us */}
                <div className="bg-white/5 border border-white/10 rounded-3xl p-10 md:p-16 text-center max-w-5xl mx-auto mb-20">
                    ...
                    <div className="flex flex-wrap justify-center gap-8">
                        {trustFactors.map((factor, i) => (
                            <div key={i} className="flex items-center gap-3">
                                ...
                                <span className="text-white font-outfit text-lg">{factor}</span>
                            </div>
                        ))}
                    </div>
                </div>
