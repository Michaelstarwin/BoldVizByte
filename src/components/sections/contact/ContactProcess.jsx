...
const steps = [
    { icon: Send, title: "1. You Contact Us", desc: "Fill the form or call directly." },
    { icon: PhoneCall, title: "2. Expert Call", desc: "We discuss your needs." },
    { icon: FileText, title: "3. Proposal", desc: "Strategy & timeline plan." },
    { icon: Rocket, title: "4. Kickoff", desc: "We start building!" }
];
